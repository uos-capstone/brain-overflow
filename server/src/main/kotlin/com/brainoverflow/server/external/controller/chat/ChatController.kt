...
class ChatController(
    ...
    private val log =
        LoggerFactory.getLogger(com.brainoverflow.server.external.controller.chat.ChatController::class.java)

    @MessageMapping("/chat.joinRoom")
    fun joinRoom(@Payload chatMessage: com.brainoverflow.server.external.dto.request.chat.ChatMessage) {
    ...
    fun sendMessage(
        @Payload chatMessage: com.brainoverflow.server.external.dto.request.chat.ChatMessage,
        principal: Principal
    ) {
        val destination = "/topic/${chatMessage.roomId}"
