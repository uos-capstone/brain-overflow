...
class AuthService(
    ...
    fun login(
        loginRequest: com.brainoverflow.server.external.dto.request.user.LoginRequest,
    ): com.brainoverflow.server.external.dto.response.user.TokenResponse {
        val user =
            userRepository.findByUsername(loginRequest.username) ?: throw BOException(
